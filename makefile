...
# -Wlarger-than=8192
CFLAGS += -I$(SOURCE_DIR)/ -I$(SOURCE_DIR)/recursive_decent -I$(SOURCE_DIR)/visuals -I$(SOURCE_DIR)/common -I$(SOURCE_DIR)/tree -I$(SOURCE_DIR)/stack -I$(SOURCE_DIR)/game -lncursesw -I$(SOURCE_DIR)/my_allocator -I$(SOURCE_DIR)/mathematics 
CFLAGS += -lstdc++ -lm 
